package com.jack.manager.common.utils;
...
class RSAUtils {
	...
	public static final String encrypt(String data) throws Exception{
		RSAPublicKey publicKey = getPublicKey(Const.RSA.modulus, Const.RSA.publicExponent);
	...
	public static final String decrypt(String data) throws Exception{
		RSAPrivateKey privateKey = getPrivateKey(Const.RSA.modulus, Const.RSA.privateExponent);
