...
<body class="gray-bg">
				...
				<div class="ibox-content">
					...
					<div class="list-group">
						<div class="list-group-item form-group">
							<input class="form-control" id="phone" type="number" placeholder="请输入电话号码" size="11" />
						</div>
					</div>
				</div>
			</div>
	...
	var save = function(){
		var phone = $("#phone").val();
		if(!notNull(phone)){
			swal("操作错误", "请输入手机号码", "error");
			return;
		}
		post("${path}/wechat/personal_center/update_phone",{phone:phone},function(){
